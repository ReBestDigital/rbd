...
export const PRICING_CONFIG: PlanFeature[] = [
  ...
  { feature: "Cod: SM027 | Carousel FixerUpper Listing Link in Bio CTA 4 slides", description: "(link in bio is not our favourite CTA but we give you this choise as well) 1:1 format 4 slides", earlyBird: { active: true, status: 'completo' }, full: { active: true, status: 'completo' }, start: { active: false, status: 'completo' } },
  ...
  { feature: "Cod: SG006 | Mastering IG Stories from basicto hook master", description: "1-18 Guide for real estate agents hooks on instagram", earlyBird: { active: true, status: 'completo' }, full: { active: true, status: 'completo' }, start: { active: false, status: 'completo' } },
  ...
  { feature: "Cod: YT003 | Life Time Access private LM Templates DrillDown YT channel to find out the WHY of the template ", description: "Strategical Templates drilldown generate by NBLM from our secret ReBest Digital Ecosystem Files", earlyBird: { active: true, status: 'completo' }, full: { active: true, status: 'completo' }, start: { active: false, status: 'completo' }} ,
  /* BONUS EARLY BIRD */
  { feature: "Section: Early Bird Bonuses", isHeader: true },
  { feature: "Cod: FB001 | Life Time Access to ReBest Digital Ecosystem Facebook Private Group", description: "Private Group with Strategies and new contents / new Templates/ info-graphics/ (for free) + extreme Discounts for new ReBest Digital tool s", earlyBird: { active: true, status: 'completo' }, full: { active: false, status: 'completo' }, start: { active: false, status: 'completo' } },
  { feature: "Cod: YT001 | Life Time Access to ReBest Digital Ecosystem youtube private LM Tecnical and Strategical playlist", description: "Strategical discussion generate by NBLM from our secret ReBest Digital Ecosystem Files", earlyBird: { active: true, status: 'completo' }, full: { active: false, status: 'completo' }, start: { active: false, status: 'completo' }} ,
  { feature: "Cod: YT002 | Life Time 48h Early Access to ReBest Digital Ecosystem youtube public LM Tecnical and Strategical video", description: "You ll have the early access to the you tube videos we are going to publish", earlyBird: { active: true, status: 'completo' }, full: { active: false, status: 'completo' }, start: { active: false, status: 'completo' } }
];