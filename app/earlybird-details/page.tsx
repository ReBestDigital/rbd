          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="border-b border-white/10 bg-white/5">
                <th className="p-2  md:p-6 text-left text-slate-300 font-bold uppercase text-base md:text-lg tracking-widest">Product / Service</th>
                <th className={`p-2  md:p-6 text-center ${style.accent} font-black text-base md:text-lg`}>EARLY BIRD</th>
                <th className="p-2  md:p-6 text-center text-slate-200 font-bold text-base md:text-lg">FULL PRICE <br></br>after 2025/03/23</th>
                <th className="p-2  md:p-6 text-center text-slate-200 font-bold text-opacity-60 text-base md:text-lg">START Pack</th>
              </tr>
              <tr className="border-b border-white/5 bg-black/20">
                <td className="p-2  md:p-4 text-left font-bold text-slate-500 italic text-lg">Investment</td>
                <td className={`p-2  md:p-4 text-center font-black text-2xl ${style.accent} text-sm md:text-xl`}>{PLAN_PRICES.earlyBird}</td>
