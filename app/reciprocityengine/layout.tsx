...
export const metadata: Metadata = {
  ...
  description: 'Stop being a digital tenant of real estate portals. Download "The Reciprocity Engine" roadmap to build your own database and become the visible authority in your area.',
  keywords: [
  ...
  openGraph: {
    ...
    type: 'website',
    url: 'https://www.rebestdigital.com/reciprocityengine',
    images: [
      {
  ...
  return (
    <section className="strategy-blueprint-section bg-slate-50">
      ...
      <div className="bg-[#ff00ff] text-white text-center py-2 text-xl font-extrabold uppercase tracking-tighter">
        ...
        Strategy Blueprint: Escape the Portals' Slavery
      </div>
