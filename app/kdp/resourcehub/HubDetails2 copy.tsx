...
<h2 className={`${style.text} text-2xl mb-12 mt-20 border-b-4 border-t-4 pb-6 pt-6 uppercase font-black text-center tracking-tighter`} style={{ borderColor: style.color || '#FFffFF' }}>
  <strong>Do you want to get your area Back?</strong> <br /> Here You will find what you need to implement</h2>

{/* SECTION 1: THE HOME BUYER CHECKLIST (Immagine a Destra) */}
<div className="flex flex-col md:flex-col items-center gap-12 py-12 border-b border-white/10">
...
{/* SECTION 3 */}
<div className="flex flex-col md:flex-col items-center gap-12 py-12">
  <div className="flex-1 order-2 md:order-1">
...
{/* SECTION 5: Business Card  (Immagine a Destra) */}
<div className="flex flex-col md:flex-col items-center gap-12 py-12">
  <div className="flex-1 order-2 md:order-1">
