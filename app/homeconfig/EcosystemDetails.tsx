      ...
      <div className="pt-20 border-t border-white/10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="bg-white/5 p-8 rounded-2xl border border-white/10">
            <h3 className="text-white font-bold mb-4 uppercase">🏢 Marketing Agency?</h3>
          ...
          <div className="bg-red-500/5 p-8 rounded-2xl border border-red-500/20">
            <h3 className="text-red-100 font-bold mb-4 uppercase text-sm">⚖️ Earnings Disclaimer</h3>
